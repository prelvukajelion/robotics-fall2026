...
def render(st):
    ...
    st.write('In 100–150 words: a robot motion program can be technically correct and still fail as part of a sociotechnical system. '
    ...
    words=word_count(synthesis);st.caption(f'{words} words; required range 100–150')
